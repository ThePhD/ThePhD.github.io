...
Take, for example, the section discussing the [public attacks made by Boost members against other Committee members](https://youtu.be/vaLKm9FE8oo?t=1860) for their work. The people who were attacked where not Black, or women. They weren't even from a marginalized culture: they were white, cis, heterosexual men -- in some cases, married with children -- working at a big tech company. One of them — Eric Niebler — had contributed to Boost for well beyond a decade: he talked at the very first Boost Con, represented Boost ideals to the Standards Committee, and is one of the most celebrated names under Stepanovian Algorithmic thinking, right next to Connor Hoekstra and Sean Parent!
